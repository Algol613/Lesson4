...
public class Lesson4 {
    ...
    public static String playerName = "Igor";
    ...
    public static void changePositionPlayer() {
        ...
        do {
            ...
            switch (playerMove) {
                case PLAYER_MOVE_UP -> playerPositionY -= 1;
                case PLAYER_MOVE_LEFT -> playerPositionX -= 1;
                case PLAYER_MOVE_RIGHT -> playerPositionX += 1;
                case PLAYER_MOVE_DOWN -> playerPositionY += 1;
            }
